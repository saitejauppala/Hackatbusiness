...
var RiskController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.RiskController = void 0;
const common_1 = require("@nestjs/common");
const risk_service_1 = require("./risk.service");
let RiskController = RiskController_1 = class RiskController {
    constructor(riskService) {
        this.riskService = riskService;
        this.logger = new common_1.Logger(RiskController_1.name);
    }
    async getRisk(routeId) {
...
], RiskController.prototype, "getRisk", null);
exports.RiskController = RiskController = RiskController_1 = __decorate([
