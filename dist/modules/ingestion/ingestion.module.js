...
exports.IngestionModule = IngestionModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [ingestion_service_1.IngestionService, ingestion_repository_1.IngestionRepository],
        exports: [ingestion_service_1.IngestionService, ingestion_repository_1.IngestionRepository],
    })
], IngestionModule);
